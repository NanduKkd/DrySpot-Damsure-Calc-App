...
class MockClientProvider extends ChangeNotifier implements ClientProvider {
  ...
  @override
  Future<void> addRectangle(dynamic rectangle) async {}
  @override
  Future<void> updateRectangle(dynamic rectangle) async {}
  @override
...
class MockSettingsProvider extends ChangeNotifier implements SettingsProvider {
  ...
  @override
  Future<void> updateDefaultPrice(dynamic defaultPrice) async {}
  @override
...
void main() {
  testWidgets('MeasurementScreen discount dialog and display test',
