...
void main() {
  ...
  test('PdfService content verification - Headers', () async {
    ...
    expect(content, contains('II. Applicability of Warranty:'),
        reason: 'Missing Section II');
    expect(content, contains('III. Commencement and Duration'),
        reason: 'Missing Section III');
    expect(content, contains('IV. Exclusions'), reason: 'Missing Section IV');
    expect(content, contains('Standard Product & Service Warranty Statement'),
        reason: 'Missing Warranty Statement header');
  });
  ...
  test('PdfService content verification - Assets', () async {
    ...
    expect(content, contains('assets/pdf-images/blueBuildingsBackground.jpg'));
    ...
    expect(content,
        contains('assets/pdf-images/franchiseeManagerNameAndSign.jpg'));
  });
}
