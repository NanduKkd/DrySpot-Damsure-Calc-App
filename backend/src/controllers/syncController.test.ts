...
describe('syncController', () => {
  ...
  beforeAll(async () => {
    // Setup Franchisees
    franchisee1 = await Franchisee.create({ id: 'f1-id', name: 'Franchisee 1', default_prices: {} });
    franchisee2 = await Franchisee.create({ id: 'f2-id', name: 'Franchisee 2', default_prices: {} });

    // Setup Users
    user1 = await User.create({ id: 'u1-id', name: 'User 1', email: 'user1@example.com', password: 'password', franchiseeId: franchisee1.id });
    user2 = await User.create({ id: 'u2-id', name: 'User 2', email: 'user2@example.com', password: 'password', franchiseeId: franchisee2.id });
