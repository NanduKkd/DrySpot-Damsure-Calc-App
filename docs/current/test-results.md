...
| Real-device / APK publication | NOT RUN | No real-device pilot or APK publication. Local signing material is ignored with restrictive permissions; approved encrypted off-device backup remains required. |
