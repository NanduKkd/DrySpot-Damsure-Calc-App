...
rg -Fq 'if ($uri !~ ^/releases/damsure-[1-9][0-9]*\.apk$) { return 404; }' "$template"
rg -Fq 'rewrite ^/releases/(damsure-[1-9][0-9]*\.apk)$ /$1 break;' "$template"
rg -Fq 'root /var/www/damsure-releases;' "$template"
rg -Fq 'try_files $uri =404;' "$template"
